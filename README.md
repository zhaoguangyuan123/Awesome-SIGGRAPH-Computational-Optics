...
|Year|Venue|Paper(w/ link)|Repo (if any)|Summary(if any)|
|---|---|---|---|---|
...
|&nbsp;|&nbsp;|[Imaging with local speckle intensity correlations: theory and practice](https://webee.technion.ac.il/people/anat.levin/papers/AltermanTOG2021SeeThrough.pdf)|[Link](https://webee.technion.ac.il/people/anat.levin/)|
...
|&nbsp;|&nbsp;|[Low-Cost SPAD Sensing for Non-Line-Of-Sight Tracking, Material Classification and Depth Imaging](https://light.princeton.edu/publication/cheapspad/)|[Link](https://github.com/princeton-computational-imaging/CheapSPAD)|
|2020|SIG ASIA|[Neural Holography with Camera-in-the-loop Training](https://www.computationalimaging.org/publications/neuralholography/)|[Link](https://github.com/computational-imaging/neural-holography)|
...
|&nbsp;|&nbsp;|[One Shot 3D Photography]()|[Link]()|
|&nbsp;|&nbsp;|[Non-Line-of-Sight Reconstruction using Efficient Transient Rendering]()|[Link]()|
...
|2019|SIG ASIA|[Learning Efficient Illumination Multiplexing for Joint Capture of Reflectance and Shape]()|[Link]()|
|&nbsp;|&nbsp;|[Handheld Mobile Photography in Very Low Light]()|[Link]()|
|&nbsp;|&nbsp;|[Learned Hardware-in-the-loop Phase Retrieval for Holographic Near-Eye Displays]()|[Link]()|
|&nbsp;|&nbsp;|[Accelerating ADMM for efficient simulation and optimization]()|[Link]()|
|&nbsp;|&nbsp;|[Learned Large Field-of-View Imaging With Thin-Plate Optics]()|[Link]()|
|&nbsp;|SIG|[Local Fourier Slice Photography]()|[Link]()|
|&nbsp;|&nbsp;|[Synthetic Defocus and Look-Ahead Autofocus for Casual Videography]()|[Link]()|
|&nbsp;|&nbsp;|[Handheld Multi-Frame Super-Resolution]()|[Link]()|
|&nbsp;|&nbsp;|[A Unified Framework for Compression and Compressed Sensing of Light Fields and Light Field Videos]()|[Link]()|
|&nbsp;|&nbsp;|[Hyperparameter Optimization in Black-box Image Processing using Differentiable Proxies]()|[Link]()|
|&nbsp;|&nbsp;|[Coding Optimization for Fast Fluorescence Lifetime Imaging]()|[Link]()|
|&nbsp;|&nbsp;|[Non-line-of-sight Imaging with Partial Occluders and Surface Normals]()|[Link]()|
|&nbsp;|&nbsp;|[Wave-based Non-line-of-sight Imaging using Fast fk-Migration]()|[Link]()|
|&nbsp;|&nbsp;|[Compact Snapshot Hyperspectral Imaging with Diffracted Rotation]()|[Link]()|
|2018|SIGG ASIA|[A System for Acquiring, Processing, and Rendering Panoramic Light Field Stills for Virtual Reality]()|[Link]()|
|&nbsp;|SIG|[What Are Optimal Coding Functions for Time-of-Flight Imaging?]()|[Link]()|
|&nbsp;|&nbsp;|[Single-Photon 3D Imaging with Deep Sensor Fusion]()|[Link]()|
|&nbsp;|&nbsp;|[End-to-end Optimization of Optics and Image Processing for Achromatic Extended Depth of Field and Super-resolution Imaging]()|[Link]()|
|&nbsp;|&nbsp;|[Megapixel Adaptive Optics: Towards Correcting Large-scale Distortions in Computational Cameras]()|[Link]()|
|2017|SIG ASIA|[A System for Acquiring, Processing, and Rendering Panoramic Light Field Stills for Virtual Reality]()|[Link]()|
|&nbsp;|&nbsp;|[Single-Photon 3D Imaging with Deep Sensor Fusion]()|[Link]()|
|&nbsp;|&nbsp;|[End-to-end Optimization of Optics and Image Processing for Achromatic Extended Depth of Field and Super-resolution Imaging]()|[Link]()|
|&nbsp;|&nbsp;|[Megapixel Adaptive Optics: Towards Correcting Large-scale Distortions in Computational Cameras]()|[Link]()|
|&nbsp;|SIG|[What Are Optimal Coding Functions for Time-of-Flight Imaging?]()|[Link]()|
...
|2017|SIGGRAPH ASIA|[Learning to Predict Indoor Illumination from a Single Image](https://arxiv.org/abs/1704.00090)|[Link](http://indoor.hdrdb.com/)|
|2018|3DV|[Learning to Estimate Indoor Lighting from 3D Objects](https://arxiv.org/abs/1806.03994)|[Code & Link] -->
